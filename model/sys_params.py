...
sys_params = {
    ...
    'initial_node_amount': [25], # initial number of nodes in the DePIN network
    ...
    'initial_network_resource_demand': [10 * 1e6], # initial network resource demand in the DePIN network / resource units
    ...
    'incentive_token_allocation': [0.6], # share of the total token supply allocated to the DePIN foundation for incentives
