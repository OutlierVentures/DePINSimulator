...
def postprocessing(df):
    ...
    data = (pd.DataFrame({'timestep': timesteps,
                          ...
                          'network_resource_demand_supply_ratio': df.network_resource_demand_supply_ratio,
                          ...
                          'token_minted_supply_cum': df.token_minted_supply_cum,
                          ...
                          'node_incentive_revenue': df.node_incentive_revenue,
